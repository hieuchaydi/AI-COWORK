...
// Persona naming: the product is "AI cowork"; the personas are a "Coworker" family — Coworker
...
// API + tests keep "AI cowork" / "Ops Coworker"); this is purely the display layer.
