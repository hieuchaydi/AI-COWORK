...
export type Item =
  ...
  // `waiting` marks the transient "parked on a quota limit" notice: it is replaced
  // by the next one and cleared once the turn moves again.
  | { kind: "notice"; tone: "info" | "warn"; text: string; retriable?: boolean; waiting?: boolean };
