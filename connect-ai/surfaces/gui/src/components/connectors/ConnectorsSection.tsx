...
const DETAIL_PAGES: Record<string, (p: DetailProps) => JSX.Element> = {
  ...
  // Drive is one of them: its accounts are the Google logins from the shared
  // sign-in, listed by email like Gmail's and Calendar's.
  google_drive: (p) => <AccountsDetail {...p} />,
