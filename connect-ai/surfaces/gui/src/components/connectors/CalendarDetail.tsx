    ...
    <div data-testid="gcal-detail">
      ...
      {!c.connected && (
        <div className={GRP}>
          <div className={ROW + " text-[12.5px] text-muted"}>
            Sign in with Google — one sign-in also connects Gmail and Drive. Each account
      ...
      {accounts.length > 0 && (
        <>
          ...
          <div className={FOOT}>
            These are Google sign-ins — the same login also runs Gmail and Google Drive.
            × removes the account from Calendar only; sign out entirely from
            Connectors ▸ Google.
          </div>
        </>
      )}
