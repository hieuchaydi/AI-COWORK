...
// reads as a screenshot of Slack), Workspace on the right (app tokens). Tabs
...
const CAPTIONS = [
  "Mention @Workspace in any channel it's invited to — a session opens here, and the answer lands back in Slack as a thread.",
    ...
    <div className="mb-5" data-testid="slack-howitworks">
      <div className="flex items-baseline gap-2.5">
        <h3 className="text-[13.5px] font-semibold tracking-tight">
          Getting started with Slack &amp; Workspace
        </h3>
        <button
...
function SlackRail({ active }: { active: string }) {
  return (
    <div className="hiw-slrail">
      ...
      <div className="hiw-slnav"><span className="hiw-appav">WS</span>Workspace</div>
    </div>
  );
}
  ...
  return (
    <div className="hiw-win hiw-ow">
      <div className="hiw-owtop">
        <span className="hiw-dots"><i /><i /><i /></span> Workspace
      </div>
...
function OwRail({ hot, hotSub, glow }: { hot?: string; hotSub?: string; glow?: boolean }) {
  return (
    <div className="hiw-owrail">
      <div className="hiw-brand">Workspace</div>
      ...
      <SlackWin>
        ...
        <div className="hiw-slmain">
          ...
          <div className="hiw-slmsgs">
            ...
            >
              <span className="hiw-men">@Workspace</span> summarize this thread
            </Msg>
          </div>
          ...
          <div className="hiw-slthread hiw-k" style={d("5.1s")}>
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="WS" avBg="#4a154b" name="Workspace" app ts="6:34 PM">
      ...
      <OwWin>
        ...
        <div className="hiw-owmain">
          ...
          <div className="hiw-owchat">
            <div className="hiw-bub user hiw-k" style={d("2.8s")}>@Workspace summarize this thread</div>
          ...
          <div className="hiw-owcomposer">Message Workspace…</div>
        </div>
      </OwWin>
    </>
  );
          ...
          <div className="hiw-slthread">
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="P" avBg="#7c6cd0" name="Priya N" ts="6:36 PM" delay=".8s">
                <span className="hiw-men">@Workspace</span> break it down by country?
              </Msg>
              <Msg av="WS" avBg="#4a154b" name="Workspace" app ts="6:36 PM" delay="4.8s">
      ...
      <SlackWin>
        ...
        <div className="hiw-slmain">
          ...
          <div className="hiw-slmsgs">
            ...
            >
              <span className="hiw-men">@Workspace</span> pull the signup numbers?
            </Msg>
          </div>
          <SlackComposer placeholder="Message #launch-room" />
        </div>
