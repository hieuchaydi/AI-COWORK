...
function VoiceInputSection() {
  ...
  return (
    <section>
      ...
      {!desktop ? (
        <div className={CARD + " p-4 text-[13px] text-muted"}>Voice Input setup is available in the desktop app.</div>
      ) : (
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="block text-[12px] text-muted">
            Curated coworkers — see what each can do before installing.
          </span>
        </span>
...
function AppearanceSection() {
  ...
  return (
    <section>
      <PanelHead title="General" sub="How Workspace looks and behaves on this machine." />
        ...
        <div className={CARD + " p-4"}>
          ...
          <label className="flex items-start gap-3 py-2">
            ...
            <span>
              ...
              <span className="block text-[12px] text-muted">Launch Workspace automatically when you sign in.</span>
            </span>
          </label>
          <label className="flex items-start gap-3 py-2">
        ...
        <span className="text-[12px] text-muted">
          {state === "none"
            ...
            : state === "error"
              ...
              : "Downloading — Workspace restarts by itself when it's ready."}
        </span>
      )}
    </span>
  );
...
// Telemetry/Privacy card removed for this release (owner ask 2026-07-22).
