// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real Workspace mark
...
test("boot splash shows the Workspace star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting Workspace|Restoring your session/)).toBeVisible();
});
