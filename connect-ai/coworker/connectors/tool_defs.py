...
TOOL_DEFS: tuple[ConnectorToolDef, ...] = (
    ...
    # The 13 persistent-browser tools (coworker/tools/browser.py — Playwright,
    # persistent Chromium profile: sign in once, agents stay signed in). These
    # defs drive the Browser connector card's tool list + per-tool toggles and
    # the §36 approval law (reads never gate; writes ask first).
    ConnectorToolDef(
        "browser",
        "browser_open",
        "Open URL",
    ...
    ConnectorToolDef(
        ...
        "Read page",
        "read",
        "Read the current page as reader-mode text (or raw HTML).",
    ),
    ConnectorToolDef(
        "browser",
        ...
        "Read element",
        "read",
        "Read text of elements matching a CSS selector.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_click",
        "Click page",
        "write",
        "Click an element by selector, visible text, or ARIA role.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_fill",
        "Fill field",
        "write",
        "Fill an input or textarea; optionally press Enter to submit.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_press",
        "Press key",
        "write",
        "Send a keyboard key to the page.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_screenshot",
        "Screenshot",
        "read",
        "Capture a screenshot into outputs/screenshots.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_wait_for",
        "Wait for element",
        "read",
        "Wait until an element is visible, hidden, or attached.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_evaluate",
        "Run JavaScript",
        "write",
        "Run JavaScript in the page context (unsandboxed).",
    ),
    ConnectorToolDef(
        "browser",
        "browser_get_links",
        "List links",
        "read",
        "List links on the page, optionally filtered.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_get_forms",
        "List forms",
        "read",
        "List forms and inputs with their selectors.",
    ),
    ConnectorToolDef(
        "browser",
        "browser_current_url",
    ...
    ConnectorToolDef(
        ...
        "Close browser",
        "write",
        "Close the browser; sign-in state persists on disk.",
    ),
    ConnectorToolDef(
        "github",
        "github_search",
    ...
    ConnectorToolDef(
        ...
        "List my repos",
        "read",
        "List repos of the authenticated user (public + private + org + collaborator). "
        "Requires connected GitHub PAT.",
    ),
    ConnectorToolDef(
        "github",
