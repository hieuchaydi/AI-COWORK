...
ABOUT: dict[str, str] = {
    ...
    "websites — separate from your personal browser, with its own persistent "
    "sign-ins and write actions subject to approval.",
...
ACCESS: dict[str, list[str]] = {
    ...
    "browser": [
        ...
        "Clicks, types, and fills forms only inside that session — writes ask first.",
        "Keeps its own sign-ins on this computer, across restarts.",
