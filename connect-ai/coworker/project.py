...
def load_agents_md(
    workspace: str | Path | None, *, global_path: Optional[str | Path] = None
) -> str:
    ...
    nested discovery is a fast-follow. Global loads even when there's no
    workspace (chat-only sessions still get user-wide conventions).
    """
